...
const CaseStudies = async ({ slice }: CaseStudiesProps): Promise<JSX.Element> => {
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto mt-6 ax-w-md text-balance text-center text-slate-300 ">
      ...
      <div className="mt-20 grid gap-16">
        {caseStudies.map((caseStudy, index) => (
          caseStudy && (
            <div className="relative grid gap-4 opacity-85 transition-opacity duration-300 hover:cursor-pointer hover:opacity-100 md:grid-cols-2 md:gap-8 lg:grid-cols-3" key={caseStudy.id}>
              ...
              <PrismicNextLink className="after:absolute after:inset-0 hover:underline" document={caseStudy} /> 
            </div>
