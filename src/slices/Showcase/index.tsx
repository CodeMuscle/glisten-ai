  ...
  return (
    ...
    >
      ...
      <PrismicRichText
        components={{
          heading2: ({ children }) => (
            <h2 className="text-balance text-center text-5xl font-medium lg:text-7xl">
              {children}
            </h2>
          ),
        }}
      ...
      <div className="mt-16 grid items-center rounded-xl border border-blue-50/20 bg-gradient-to-b from-slate-50/15 to-slate-50/5 p-8 backdrop-blur-sm lg:grid-cols-3 lg:py-12">
        ...
        <PrismicNextImage field={slice.primary.image} className={clsx("opacity-90 shadow-2xl lg:col-span-2 lg:pt-0", "lg:-order-1 lg:-translate-x-[10%] rounded-xl border border-blue-50/20")} />
      </div>
    </Bounded>
  );
};
